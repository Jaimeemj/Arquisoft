...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get("COBROS_DB", "app_db"),
        'USER': os.environ.get("COBROS_DB_USER", "app_user"),
        'PASSWORD': os.environ.get("COBRPS_DB_PASSWORD", "isis2503"),
        'HOST': os.environ.get("COBRPS_DB_HOST", "10.128.0.82"),
